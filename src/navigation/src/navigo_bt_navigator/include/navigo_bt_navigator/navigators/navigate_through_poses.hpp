...
#ifndef NAVIGO_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_POSES_HPP_
#define NAVIGO_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_POSES_HPP_
...
#include "navigo_bt_navigator/navigator.hpp"
 ...
 */
class NavigateThroughPosesNavigator
  : public navigo_bt_navigator::Navigator<nav2_msgs::action::NavigateThroughPoses>
{
public:
  ...
  bool configure(
    ...
    std::shared_ptr<navigo_util::OdomSmoother> odom_smoother) override;
...
protected:
  ...
  void goalCompleted(
    ...
    const navigo_behavior_tree::BtStatus final_bt_status) override;
...
#endif  // NAVIGO_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_POSES_HPP_
