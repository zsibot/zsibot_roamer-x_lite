...
#ifndef NAVIGO_PATH_CONTROLLER__CONTROLLER_SERVER_HPP_
#define NAVIGO_PATH_CONTROLLER__CONTROLLER_SERVER_HPP_
...
/**
 * @class navigo_path_controller::ControllerServer
 ...
 */
class ControllerServer : public navigo_util::LifecycleNode
{
public:
  using ControllerMap = std::unordered_map<std::string, navigo_core::Controller::Ptr>;
  using GoalCheckerMap = std::unordered_map<std::string, navigo_core::GoalChecker::Ptr>;

  /**
   * @brief Constructor for navigo_path_controller::ControllerServer
   * @param options Additional options to control creation of the node.
   */
  explicit ControllerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief Destructor for navigo_path_controller::ControllerServer
   */
  ~ControllerServer();
...
protected:
  ...
  pluginlib::ClassLoader<navigo_core::ProgressChecker> progress_checker_loader_;
  navigo_core::ProgressChecker::Ptr progress_checker_;
  ...
  // Goal Checker Plugin
  pluginlib::ClassLoader<navigo_core::GoalChecker> goal_checker_loader_;
  ...
  // Controller Plugins
  pluginlib::ClassLoader<navigo_core::Controller> lp_loader_;
...
#endif  // NAVIGO_PATH_CONTROLLER__CONTROLLER_SERVER_HPP_
