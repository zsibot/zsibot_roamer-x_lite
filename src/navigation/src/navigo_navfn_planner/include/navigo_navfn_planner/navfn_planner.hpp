...
#ifndef NAVIGO_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
#define NAVIGO_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
...
class NavfnPlanner : public navigo_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
...
#endif  // NAVIGO_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
