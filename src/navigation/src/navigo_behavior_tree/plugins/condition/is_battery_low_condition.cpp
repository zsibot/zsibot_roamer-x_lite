...
#include "navigo_behavior_tree/plugins/condition/is_battery_low_condition.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::IsBatteryLowCondition>("IsBatteryLow");
}
