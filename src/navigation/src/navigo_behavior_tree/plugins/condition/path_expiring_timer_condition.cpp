...
#include "navigo_behavior_tree/plugins/condition/path_expiring_timer_condition.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::PathExpiringTimerCondition>("PathExpiringTimer");
}
