...
#include "navigo_behavior_tree/plugins/condition/transform_available_condition.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::TransformAvailableCondition>("TransformAvailable");
}
