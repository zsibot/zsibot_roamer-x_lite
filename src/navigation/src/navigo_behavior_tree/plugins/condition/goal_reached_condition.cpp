...
#include "navigo_behavior_tree/plugins/condition/goal_reached_condition.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::GoalReachedCondition>("GoalReached");
}
