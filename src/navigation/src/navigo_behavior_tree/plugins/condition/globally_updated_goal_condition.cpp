...
#include "navigo_behavior_tree/plugins/condition/globally_updated_goal_condition.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::GloballyUpdatedGoalCondition>("GlobalUpdatedGoal");
}
