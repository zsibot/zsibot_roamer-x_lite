...
#include "navigo_behavior_tree/plugins/condition/time_expired_condition.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::TimeExpiredCondition>("TimeExpired");
}
