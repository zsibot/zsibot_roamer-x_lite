...
#include "navigo_behavior_tree/plugins/condition/is_path_valid_condition.hpp"
#include <chrono>
#include <memory>
#include <string>
...
{
  factory.registerNodeType<navigo_behavior_tree::IsPathValidCondition>("IsPathValid");
}
