...
#include <string>
#include <vector>
#include "navigo_behavior_tree/plugins/condition/goal_updated_condition.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::GoalUpdatedCondition>("GoalUpdated");
}
