...
#include "navigo_behavior_tree/plugins/condition/distance_traveled_condition.hpp"
...
BT::NodeStatus DistanceTraveledCondition::tick()
{
  ...
  auto travelled = navigo_util::geometry_utils::euclidean_distance(
...
{
  factory.registerNodeType<navigo_behavior_tree::DistanceTraveledCondition>("DistanceTraveled");
}
