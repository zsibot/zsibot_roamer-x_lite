...
#include "navigo_behavior_tree/plugins/condition/is_battery_charging_condition.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::IsBatteryChargingCondition>("IsBatteryCharging");
}
