...
#include "navigo_behavior_tree/plugins/decorator/distance_controller.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::DistanceController>("DistanceController");
}
