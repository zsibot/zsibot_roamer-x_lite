...
#include "navigo_behavior_tree/plugins/decorator/goal_updated_controller.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::GoalUpdatedController>("GoalUpdatedController");
}
