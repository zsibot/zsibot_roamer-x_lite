...
#include "navigo_behavior_tree/plugins/action/assisted_teleop_cancel_node.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigo_behavior_tree::AssistedTeleopCancel>(
        name, "assisted_teleop", config);
    };

  factory.registerBuilder<navigo_behavior_tree::AssistedTeleopCancel>(
