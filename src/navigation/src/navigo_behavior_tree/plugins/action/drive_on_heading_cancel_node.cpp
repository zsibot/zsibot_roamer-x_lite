...
#include "navigo_behavior_tree/plugins/action/drive_on_heading_cancel_node.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigo_behavior_tree::DriveOnHeadingCancel>(
        name, "drive_on_heading", config);
    };

  factory.registerBuilder<navigo_behavior_tree::DriveOnHeadingCancel>(
