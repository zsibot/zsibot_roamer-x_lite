...
#include "navigo_behavior_tree/plugins/action/get_pose_from_path_action.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::GetPoseFromPath>("GetPoseFromPath");
}
