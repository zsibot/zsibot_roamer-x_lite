...
#include "navigo_behavior_tree/plugins/action/assisted_teleop_action.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigo_behavior_tree::AssistedTeleopAction>(
        name, "assisted_teleop", config);
    };

  factory.registerBuilder<navigo_behavior_tree::AssistedTeleopAction>("AssistedTeleop", builder);
}
