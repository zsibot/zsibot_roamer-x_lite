...
#include "navigo_behavior_tree/plugins/action/progress_checker_selector_node.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::ProgressCheckerSelector>("ProgressCheckerSelector");
}
