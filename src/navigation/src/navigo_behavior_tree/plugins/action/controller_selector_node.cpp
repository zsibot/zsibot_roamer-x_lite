...
#include "navigo_behavior_tree/plugins/action/controller_selector_node.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::ControllerSelector>("ControllerSelector");
}
