...
#include "navigo_behavior_tree/plugins/action/remove_passed_goals_action.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::RemovePassedGoals>("RemovePassedGoals");
}
