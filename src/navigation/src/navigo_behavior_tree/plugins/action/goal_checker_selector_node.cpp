...
#include "navigo_behavior_tree/plugins/action/goal_checker_selector_node.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::GoalCheckerSelector>("GoalCheckerSelector");
}
