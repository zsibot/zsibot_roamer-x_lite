...
#include "navigo_behavior_tree/plugins/action/clear_costmap_service.hpp"
...
{
  factory.registerNodeType<navigo_behavior_tree::ClearEntireCostmapService>("ClearEntireCostmap");
  factory.registerNodeType<navigo_behavior_tree::ClearCostmapExceptRegionService>(
    "ClearCostmapExceptRegion");
  factory.registerNodeType<navigo_behavior_tree::ClearCostmapAroundRobotService>(
