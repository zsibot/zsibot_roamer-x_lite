...
#include "navigo_behavior_tree/plugins/action/smooth_path_action.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigo_behavior_tree::SmoothPathAction>(
        name, "smooth_path", config);
    };

  factory.registerBuilder<navigo_behavior_tree::SmoothPathAction>(
    "SmoothPath", builder);
}
