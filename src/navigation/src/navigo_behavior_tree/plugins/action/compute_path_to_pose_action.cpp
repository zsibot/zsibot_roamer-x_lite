...
#include "navigo_behavior_tree/plugins/action/compute_path_to_pose_action.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigo_behavior_tree::ComputePathToPoseAction>(
        name, "compute_path_to_pose", config);
    };

  factory.registerBuilder<navigo_behavior_tree::ComputePathToPoseAction>(
