...
#include "navigo_behavior_tree/plugins/action/compute_path_through_poses_action.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigo_behavior_tree::ComputePathThroughPosesAction>(
        name, "compute_path_through_poses", config);
    };

  factory.registerBuilder<navigo_behavior_tree::ComputePathThroughPosesAction>(
