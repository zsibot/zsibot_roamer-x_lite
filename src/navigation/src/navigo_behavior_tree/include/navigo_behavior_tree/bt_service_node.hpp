...
#ifndef NAVIGO_BEHAVIOR_TREE__BT_SERVICE_NODE_HPP_
#define NAVIGO_BEHAVIOR_TREE__BT_SERVICE_NODE_HPP_
...
public:
  /**
   * @brief A navigo_behavior_tree::BtServiceNode constructor
...
#endif  // NAVIGO_BEHAVIOR_TREE__BT_SERVICE_NODE_HPP_
