...
#ifndef NAVIGO_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
#define NAVIGO_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
...
#include "navigo_behavior_tree/behavior_tree_engine.hpp"
#include "navigo_behavior_tree/ros_topic_logger.hpp"
...
{
/**
 * @class navigo_behavior_tree::BtActionServer
...
public:
  ...
  typedef std::function<void (typename ActionT::Result::SharedPtr,
      navigo_behavior_tree::BtStatus)> OnCompletionCallback;

  /**
   * @brief A constructor for navigo_behavior_tree::BtActionServer class
   */
  ...
  /**
   * @brief A destructor for navigo_behavior_tree::BtActionServer class
   */
  ~BtActionServer();
...
protected:
  ...
  std::unique_ptr<navigo_behavior_tree::BehaviorTreeEngine> bt_;
...
#include <navigo_behavior_tree/bt_action_server_impl.hpp>  // NOLINT(build/include_order)
#endif  // NAVIGO_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
