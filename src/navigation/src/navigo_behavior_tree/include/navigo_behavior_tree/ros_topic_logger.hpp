...
#ifndef NAVIGO_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
#define NAVIGO_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::RosTopicLogger
...
#endif   // NAVIGO_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
