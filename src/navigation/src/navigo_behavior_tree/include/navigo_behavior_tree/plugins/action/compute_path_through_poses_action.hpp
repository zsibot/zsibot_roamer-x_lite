...
#ifndef NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__COMPUTE_PATH_THROUGH_POSES_ACTION_HPP_
#define NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__COMPUTE_PATH_THROUGH_POSES_ACTION_HPP_
...
/**
 * @brief A navigo_behavior_tree::BtActionNode class that wraps nav2_msgs::action::ComputePathThroughPoses
 */
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::ComputePathThroughPosesAction
...
#endif  // NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__COMPUTE_PATH_THROUGH_POSES_ACTION_HPP_
