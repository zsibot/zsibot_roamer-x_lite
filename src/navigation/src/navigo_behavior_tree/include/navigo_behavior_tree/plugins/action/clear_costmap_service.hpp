...
#ifndef NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__CLEAR_COSTMAP_SERVICE_HPP_
#define NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__CLEAR_COSTMAP_SERVICE_HPP_
...
/**
 * @brief A navigo_behavior_tree::BtServiceNode class that wraps nav2_msgs::srv::ClearEntireCostmap
 */
class ClearEntireCostmapService : public BtServiceNode<nav2_msgs::srv::ClearEntireCostmap>
{
public:
  /**
   * @brief A constructor for navigo_behavior_tree::ClearEntireCostmapService
...
/**
 * @brief A navigo_behavior_tree::BtServiceNode class that
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::ClearCostmapExceptRegionService
   * @param service_node_name Service name this node creates a client for
   * @param conf BT node configuration
   */
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::ClearCostmapAroundRobotService
   * @param service_node_name Service name this node creates a client for
   * @param conf BT node configuration
   */
...
#endif  // NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__CLEAR_COSTMAP_SERVICE_HPP_
