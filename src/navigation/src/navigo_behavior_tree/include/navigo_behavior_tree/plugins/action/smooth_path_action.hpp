...
#ifndef NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__SMOOTH_PATH_ACTION_HPP_
#define NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__SMOOTH_PATH_ACTION_HPP_
...
/**
 * @brief A navigo_behavior_tree::BtActionNode class that wraps nav2_msgs::action::SmoothPath
 */
class SmoothPathAction : public navigo_behavior_tree::BtActionNode<nav2_msgs::action::SmoothPath>
{
public:
  /**
   * @brief A constructor for navigo_behavior_tree::SmoothPathAction
...
#endif  // NAVIGO_BEHAVIOR_TREE__PLUGINS__ACTION__SMOOTH_PATH_ACTION_HPP_
