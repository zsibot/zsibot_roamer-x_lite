...
#ifndef NAVIGO_BEHAVIOR_TREE__PLUGINS__CONTROL__RECOVERY_NODE_HPP_
#define NAVIGO_BEHAVIOR_TREE__PLUGINS__CONTROL__RECOVERY_NODE_HPP_
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::RecoveryNode
  ...
  /**
   * @brief A destructor for navigo_behavior_tree::RecoveryNode
   */
...
#endif  // NAVIGO_BEHAVIOR_TREE__PLUGINS__CONTROL__RECOVERY_NODE_HPP_
