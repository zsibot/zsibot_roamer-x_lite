...
#ifndef NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STUCK_CONDITION_HPP_
#define NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STUCK_CONDITION_HPP_
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::IsStuckCondition
  ...
  /**
   * @brief A destructor for navigo_behavior_tree::IsStuckCondition
   */
...
#endif  // NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STUCK_CONDITION_HPP_
