...
#ifndef NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__TRANSFORM_AVAILABLE_CONDITION_HPP_
#define NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__TRANSFORM_AVAILABLE_CONDITION_HPP_
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::TransformAvailableCondition
  ...
  /**
   * @brief A destructor for navigo_behavior_tree::TransformAvailableCondition
   */
  ~TransformAvailableCondition();
...
#endif  // NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__TRANSFORM_AVAILABLE_CONDITION_HPP_
