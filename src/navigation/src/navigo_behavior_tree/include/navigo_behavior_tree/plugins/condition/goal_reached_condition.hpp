...
#ifndef NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__GOAL_REACHED_CONDITION_HPP_
#define NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__GOAL_REACHED_CONDITION_HPP_
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::GoalReachedCondition
  ...
  /**
   * @brief A destructor for navigo_behavior_tree::GoalReachedCondition
   */
...
#endif  // NAVIGO_BEHAVIOR_TREE__PLUGINS__CONDITION__GOAL_REACHED_CONDITION_HPP_
