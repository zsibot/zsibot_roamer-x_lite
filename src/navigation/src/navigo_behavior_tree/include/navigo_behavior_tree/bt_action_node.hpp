...
#ifndef NAVIGO_BEHAVIOR_TREE__BT_ACTION_NODE_HPP_
#define NAVIGO_BEHAVIOR_TREE__BT_ACTION_NODE_HPP_
...
public:
  /**
   * @brief A navigo_behavior_tree::BtActionNode constructor
...
#endif  // NAVIGO_BEHAVIOR_TREE__BT_ACTION_NODE_HPP_
