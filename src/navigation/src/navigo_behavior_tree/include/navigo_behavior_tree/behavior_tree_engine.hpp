...
#ifndef NAVIGO_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
#define NAVIGO_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
...
public:
  /**
   * @brief A constructor for navigo_behavior_tree::BehaviorTreeEngine
   ...
   * @return navigo_behavior_tree::BtStatus Status of BT execution
   */
  BtStatus run(
    BT::Tree * tree,
...
#endif  // NAVIGO_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
