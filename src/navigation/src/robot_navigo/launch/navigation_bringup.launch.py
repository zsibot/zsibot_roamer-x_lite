...
def generate_launch_description():
    ...
    platform_warn_log = LogInfo(
        ...
        msg="\033[1;31mWarning: You have not specified the 'platform'. [platform:=GAZEBO || platform:=NX_YSC3588 || platform:=NX_XG3588 || platform:=XG3588] Early Terminated\033[0m"
    )
