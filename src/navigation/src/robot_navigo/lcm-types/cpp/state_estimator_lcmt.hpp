...
int state_estimator_lcmt::_encodeNoHash(void *buf, int offset,
                                        int maxlen) const {
  int pos = 0, tlen;
  ...
  tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->vWorld[0],
                              3);
  if (tlen < 0)
    return tlen;
  else
  ...
  tlen =
      __float_encode_array(buf, offset + pos, maxlen - pos, &this->vBody[0], 3);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
  ...
  tlen =
      __float_encode_array(buf, offset + pos, maxlen - pos, &this->quat[0], 4);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
int state_estimator_lcmt::_decodeNoHash(const void *buf, int offset,
                                        int maxlen) {
  int pos = 0, tlen;
  ...
  tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->vWorld[0],
                              3);
  if (tlen < 0)
    return tlen;
  else
  ...
  tlen =
      __float_decode_array(buf, offset + pos, maxlen - pos, &this->vBody[0], 3);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
  ...
  tlen =
      __float_decode_array(buf, offset + pos, maxlen - pos, &this->quat[0], 4);
  if (tlen < 0)
    return tlen;
  else
    pos += tlen;
...
uint64_t state_estimator_lcmt::_computeHash(const __lcm_hash_ptr *) {
  uint64_t hash = 0x2ad3314b71e545aeLL;
