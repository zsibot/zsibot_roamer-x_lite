...
#ifndef NAVIGO_COSTMAP_2D__FOOTPRINT_SUBSCRIBER_HPP_
#define NAVIGO_COSTMAP_2D__FOOTPRINT_SUBSCRIBER_HPP_
...
#endif  // NAVIGO_COSTMAP_2D__FOOTPRINT_SUBSCRIBER_HPP_
