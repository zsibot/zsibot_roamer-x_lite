...
#ifndef NAVIGO_COSTMAP_2D__CLEAR_COSTMAP_SERVICE_HPP_
#define NAVIGO_COSTMAP_2D__CLEAR_COSTMAP_SERVICE_HPP_
...
public:
   ...
   * @brief A constructor
   */
  ClearCostmapService(const navigo_util::LifecycleNode::WeakPtr & parent, Costmap2DROS & costmap);
...
private:
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("navigo_costmap_2d")};
...
#endif  // NAVIGO_COSTMAP_2D__CLEAR_COSTMAP_SERVICE_HPP_
