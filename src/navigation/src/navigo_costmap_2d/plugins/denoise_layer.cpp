...
#include "navigo_costmap_2d/denoise_layer.hpp"
...
DenoiseLayer::updateCosts(
  navigo_costmap_2d::Costmap2D & master_grid, int min_x, int min_y, int max_x, int max_y)
{
  if (!enabled_) {
    return;
  }
...
// to be registered in order to be dynamically loadable of base type navigo_costmap_2d::Layer.
#include "pluginlib/class_list_macros.hpp"
PLUGINLIB_EXPORT_CLASS(navigo_costmap_2d::DenoiseLayer, navigo_costmap_2d::Layer)
