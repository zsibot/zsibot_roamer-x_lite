...
#ifndef NAVIGO_COLLISION_MONITOR__POLYGON_HPP_
#define NAVIGO_COLLISION_MONITOR__POLYGON_HPP_
...
protected:
  ...
  navigo_util::LifecycleNode::WeakPtr node_;
...
#endif  // NAVIGO_COLLISION_MONITOR__POLYGON_HPP_
