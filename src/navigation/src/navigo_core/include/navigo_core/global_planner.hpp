...
#ifndef NAVIGO_CORE__GLOBAL_PLANNER_HPP_
#define NAVIGO_CORE__GLOBAL_PLANNER_HPP_
...
public:
  ...
  virtual void configure(
    ...
    std::shared_ptr<navigo_costmap_2d::Costmap2DROS> costmap_ros) = 0;
...
#endif  // NAVIGO_CORE__GLOBAL_PLANNER_HPP_
