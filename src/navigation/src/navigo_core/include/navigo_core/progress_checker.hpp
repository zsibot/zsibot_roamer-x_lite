...
#ifndef NAVIGO_CORE__PROGRESS_CHECKER_HPP_
#define NAVIGO_CORE__PROGRESS_CHECKER_HPP_
...
{
/**
 * @class navigo_core::ProgressChecker
...
{
public:
  typedef std::shared_ptr<navigo_core::ProgressChecker> Ptr;
...
#endif  // NAVIGO_CORE__PROGRESS_CHECKER_HPP_
