...
#ifndef NAVIGO_CORE__SMOOTHER_HPP_
#define NAVIGO_CORE__SMOOTHER_HPP_
...
{
public:
  using Ptr = std::shared_ptr<navigo_core::Smoother>;
  ...
  virtual void configure(
    ...
    std::shared_ptr<navigo_costmap_2d::FootprintSubscriber>) = 0;
...
#endif  // NAVIGO_CORE__SMOOTHER_HPP_
