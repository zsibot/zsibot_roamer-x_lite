...
#ifndef NAVIGO_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_
#define NAVIGO_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_
...
#endif  // NAVIGO_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_
