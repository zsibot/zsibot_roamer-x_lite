...
#ifndef NAVIGO_MPPI_CONTROLLER__CRITICS__OBSTACLES_CRITIC_HPP_
#define NAVIGO_MPPI_CONTROLLER__CRITICS__OBSTACLES_CRITIC_HPP_
...
protected:
  ...
  /**
    ...
    */
  float findCircumscribedCost(std::shared_ptr<navigo_costmap_2d::Costmap2DROS> costmap);

protected:
  navigo_costmap_2d::FootprintCollisionChecker<navigo_costmap_2d::Costmap2D *>
...
#endif  // NAVIGO_MPPI_CONTROLLER__CRITICS__OBSTACLES_CRITIC_HPP_
