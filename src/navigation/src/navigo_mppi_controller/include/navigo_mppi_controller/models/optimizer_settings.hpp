...
#ifndef NAVIGO_MPPI_CONTROLLER__MODELS__OPTIMIZER_SETTINGS_HPP_
#define NAVIGO_MPPI_CONTROLLER__MODELS__OPTIMIZER_SETTINGS_HPP_
...
#endif  // NAVIGO_MPPI_CONTROLLER__MODELS__OPTIMIZER_SETTINGS_HPP_
