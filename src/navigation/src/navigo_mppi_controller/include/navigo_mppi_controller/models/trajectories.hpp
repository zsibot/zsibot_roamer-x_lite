...
#ifndef NAVIGO_MPPI_CONTROLLER__MODELS__TRAJECTORIES_HPP_
#define NAVIGO_MPPI_CONTROLLER__MODELS__TRAJECTORIES_HPP_
...
#endif  // NAVIGO_MPPI_CONTROLLER__MODELS__TRAJECTORIES_HPP_
