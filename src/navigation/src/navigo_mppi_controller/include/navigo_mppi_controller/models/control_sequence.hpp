...
#ifndef NAVIGO_MPPI_CONTROLLER__MODELS__CONTROL_SEQUENCE_HPP_
#define NAVIGO_MPPI_CONTROLLER__MODELS__CONTROL_SEQUENCE_HPP_
...
#endif  // NAVIGO_MPPI_CONTROLLER__MODELS__CONTROL_SEQUENCE_HPP_
