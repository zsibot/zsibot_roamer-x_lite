...
#ifndef NAVIGO_MPPI_CONTROLLER__CRITIC_MANAGER_HPP_
#define NAVIGO_MPPI_CONTROLLER__CRITIC_MANAGER_HPP_
...
public:
  ...
  void on_configure(
    ...
    std::shared_ptr<navigo_costmap_2d::Costmap2DROS>, ParametersHandler *);
...
#endif  // NAVIGO_MPPI_CONTROLLER__CRITIC_MANAGER_HPP_
