...
#ifndef NAVIGO_MPPI_CONTROLLER__OPTIMIZER_HPP_
#define NAVIGO_MPPI_CONTROLLER__OPTIMIZER_HPP_
...
#include "navigo_mppi_controller/models/optimizer_settings.hpp"
#include "navigo_mppi_controller/motion_models.hpp"
#include "navigo_mppi_controller/critic_manager.hpp"
...
#include "navigo_mppi_controller/tools/noise_generator.hpp"
#include "navigo_mppi_controller/tools/parameters_handler.hpp"
...
public:
  ...
  geometry_msgs::msg::TwistStamped evalControl(
    ...
    const geometry_msgs::msg::Pose & goal, navigo_core::GoalChecker * goal_checker);
...
#endif  // NAVIGO_MPPI_CONTROLLER__OPTIMIZER_HPP_
