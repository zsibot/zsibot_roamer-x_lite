...
#ifndef NAVIGO_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
#define NAVIGO_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
...
public:
  ...
  void initialize(
    ...
    std::shared_ptr<navigo_costmap_2d::Costmap2DROS>,
...
protected:
  ...
  std::string name_;
  std::shared_ptr<navigo_costmap_2d::Costmap2DROS> costmap_;
...
#endif  // NAVIGO_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
