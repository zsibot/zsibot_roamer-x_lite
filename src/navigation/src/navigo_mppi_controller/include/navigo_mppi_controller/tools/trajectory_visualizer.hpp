...
#ifndef NAVIGO_MPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
#define NAVIGO_MPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
...
#endif  // NAVIGO_MPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
