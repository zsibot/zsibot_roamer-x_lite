...
#ifndef NAVIGO_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
#define NAVIGO_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
...
#include "navigo_mppi_controller/critic_data.hpp"
  ...
  std::shared_ptr<navigo_costmap_2d::Costmap2DROS> costmap_ros)
{
  ...
  for (unsigned int idx = 0; idx < path_segments_count; idx++) {
    ...
    switch (costmap->getCost(map_x, map_y)) {
      using namespace navigo_costmap_2d; // NOLINT
...
#endif  // NAVIGO_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
