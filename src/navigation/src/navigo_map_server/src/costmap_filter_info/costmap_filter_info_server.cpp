...
#include "navigo_map_server/costmap_filter_info_server.hpp"
...
: navigo_util::LifecycleNode("costmap_filter_info_server", "", options)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(navigo_map_server::CostmapFilterInfoServer)
