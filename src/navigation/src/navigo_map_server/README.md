...
```
$ ros2 run navigo_map_server map_saver_cli [arguments] [--ros-args ROS remapping args]
```
...
`navigo_map_server/launch/map_saver_server.launch.py` launch-file could be used.
