...
#ifndef NAVIGO_MAP_SERVER__COSTMAP_FILTER_INFO_SERVER_HPP_
#define NAVIGO_MAP_SERVER__COSTMAP_FILTER_INFO_SERVER_HPP_
...
class CostmapFilterInfoServer : public navigo_util::LifecycleNode
{
public:
  /**
   * @brief Constructor for the navigo_map_server::CostmapFilterInfoServer
   * @param options Additional options to control creation of the node.
   */
  explicit CostmapFilterInfoServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());

  /**
   * @brief Destructor for the navigo_map_server::CostmapFilterInfoServer
   */
...
#endif  // NAVIGO_MAP_SERVER__COSTMAP_FILTER_INFO_SERVER_HPP_
