...
#ifndef NAVIGO_MAP_SERVER__MAP_SAVER_HPP_
#define NAVIGO_MAP_SERVER__MAP_SAVER_HPP_
...
/**
 * @class navigo_map_server::MapSaver
 * @brief A class that provides map saving methods and services
 */
class MapSaver : public navigo_util::LifecycleNode
{
public:
  /**
   * @brief Constructor for the navigo_map_server::MapSaver
   * @param options Additional options to control creation of the node.
   */
  explicit MapSaver(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());

  /**
   * @brief Destructor for the navigo_map_server::MapServer
   */
  ~MapSaver();
...
#endif  // NAVIGO_MAP_SERVER__MAP_SAVER_HPP_
