...
#ifndef NAVIGO_MAP_SERVER__MAP_SERVER_HPP_
#define NAVIGO_MAP_SERVER__MAP_SERVER_HPP_
...
namespace navigo_map_server
{
    ...
    /**
     * @class navigo_map_server::MapServer
     * @brief Parses the map yaml file and creates a service and a publisher that
     * provides occupancy grid
     */
    class MapServer : public navigo_util::LifecycleNode
    {
    public:
        /**
         * @brief A constructor for navigo_map_server::MapServer
         * @param options Additional options to control creation of the node.
         */
        explicit MapServer(const rclcpp::NodeOptions& options = rclcpp::NodeOptions());

        /**
         * @brief A Destructor for navigo_map_server::MapServer
         */
        ~MapServer();
    ...
    protected:
         ...
         * @param response Service response
         */
        void loadMapCallback(const std::shared_ptr<rmw_request_id_t> request_header,
        ...
        // Use callback group to handle GetMap and LoadMap service
...
#endif  // NAVIGO_MAP_SERVER__MAP_SERVER_HPP_
