...
#ifndef NAVIGO_BEHAVIORS__TIMED_BEHAVIOR_HPP_
#define NAVIGO_BEHAVIORS__TIMED_BEHAVIOR_HPP_
...
public:
  ...
  void configure(
    ...
    std::shared_ptr<navigo_costmap_2d::CostmapTopicCollisionChecker> collision_checker) override
  {
    node_ = parent;
...
protected:
  ...
  // Logger
  rclcpp::Logger logger_{rclcpp::get_logger("navigo_behaviors")};
...
#endif  // NAVIGO_BEHAVIORS__TIMED_BEHAVIOR_HPP_
