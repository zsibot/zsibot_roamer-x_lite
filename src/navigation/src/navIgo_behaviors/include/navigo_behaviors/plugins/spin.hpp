...
#ifndef NAVIGO_BEHAVIORS__PLUGINS__SPIN_HPP_
#define NAVIGO_BEHAVIORS__PLUGINS__SPIN_HPP_
...
public:
  /**
   * @brief A constructor for navigo_behaviors::Spin
   */
  Spin();
  ~Spin();
...
#endif  // NAVIGO_BEHAVIORS__PLUGINS__SPIN_HPP_
