...
#ifndef NAVIGO_BEHAVIORS__PLUGINS__ASSISTED_TELEOP_HPP_
#define NAVIGO_BEHAVIORS__PLUGINS__ASSISTED_TELEOP_HPP_
...
/**
 * @class navigo_behaviors::AssistedTeleop
...
#endif  // NAVIGO_BEHAVIORS__PLUGINS__ASSISTED_TELEOP_HPP_
