...
#include "navigo_core/behavior.hpp"

#ifndef NAVIGO_BEHAVIORS__BEHAVIOR_SERVER_HPP_
#define NAVIGO_BEHAVIORS__BEHAVIOR_SERVER_HPP_
 ...
 */
class BehaviorServer : public navigo_util::LifecycleNode
{
public:
  /**
...
protected:
  ...
  // Plugins
  pluginlib::ClassLoader<navigo_core::Behavior> plugin_loader_;
  std::vector<pluginlib::UniquePtr<navigo_core::Behavior>> behaviors_;
  ...
  // Utilities
  std::unique_ptr<navigo_costmap_2d::CostmapSubscriber> costmap_sub_;
...
#endif  // NAVIGO_BEHAVIORS__BEHAVIOR_SERVER_HPP_
