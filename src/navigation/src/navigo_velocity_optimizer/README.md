...
The ``navigo_velocity_optimizer`` is a package containing a lifecycle-component node for smoothing velocities sent by Nav2 to robot controllers.
...
See inline description of parameters in the `VelocityOptimizer`.
