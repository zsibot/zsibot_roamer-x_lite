...
#ifndef NAVIGO_VELOCITY_OPTIMIZER__VELOCITY_SMOOTHER_HPP_
#define NAVIGO_VELOCITY_OPTIMIZER__VELOCITY_SMOOTHER_HPP_
...
/**
 * @class navigo_velocity_optimizer::VelocityOptimizer
 * @brief This class that smooths cmd_vel velocities for robot bases
 */
class VelocityOptimizer : public navigo_util::LifecycleNode
{
public:
  /**
   * @brief A constructor for navigo_velocity_optimizer::VelocityOptimizer
   * @param options Additional options to control creation of the node.
   */
  explicit VelocityOptimizer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());

  /**
   * @brief Destructor for navigo_velocity_optimizer::VelocityOptimizer
   */
  ~VelocityOptimizer();
...
#endif  // NAVIGO_VELOCITY_OPTIMIZER__VELOCITY_SMOOTHER_HPP_
