...
#ifndef NAVIGO_UTIL__LIFECYCLE_NODE_HPP_
#define NAVIGO_UTIL__LIFECYCLE_NODE_HPP_

#include <memory>
#include <string>
#include <thread>

#include "navigo_util/node_thread.hpp"
...
/**
 * @class navigo_util::LifecycleNode
...
public:
   ...
   */
  std::shared_ptr<navigo_util::LifecycleNode> shared_from_this()
  {
    return std::static_pointer_cast<navigo_util::LifecycleNode>(
   ...
   */
  navigo_util::CallbackReturn on_error(const rclcpp_lifecycle::State & /*state*/)
  {
    RCLCPP_FATAL(
      get_logger(),
...
#endif  // NAVIGO_UTIL__LIFECYCLE_NODE_HPP_
