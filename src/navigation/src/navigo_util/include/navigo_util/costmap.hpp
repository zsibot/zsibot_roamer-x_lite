...
#ifndef NAVIGO_UTIL__COSTMAP_HPP_
#define NAVIGO_UTIL__COSTMAP_HPP_
...
public:
  ...
  /**
   * @brief A constructor for navigo_util::Costmap
...
#endif  // NAVIGO_UTIL__COSTMAP_HPP_
