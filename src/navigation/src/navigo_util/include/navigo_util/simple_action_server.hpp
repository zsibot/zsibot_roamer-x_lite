...
#ifndef NAVIGO_UTIL__SIMPLE_ACTION_SERVER_HPP_
#define NAVIGO_UTIL__SIMPLE_ACTION_SERVER_HPP_
...
/**
 * @class navigo_util::SimpleActionServer
...
#endif   // NAVIGO_UTIL__SIMPLE_ACTION_SERVER_HPP_
